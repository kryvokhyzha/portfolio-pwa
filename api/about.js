...
module.exports = async () => [
    ...
    '<p class="list-hyphens">🔹 develop custom tools for process automation (custom automl, data quality monitoring)</p>',
    '<p class="list-hyphens">🔹 work with a huge amount of data (structured and unstructured)</p>',
